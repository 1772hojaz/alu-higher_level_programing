#!/usr/bin/python3
"""
Create a folder named models with an empty
file __init__.py inside - with this file, the folder will become a Python package
"""
import json
import csv
import turtle
...
class Base:
    """
    class has a private attribute __nb_objects = 0
    ...
    def to_json_string(list_dictionaries):
        """
        functions returns the json string representation
    ...
    def draw(list_rectangles, list_squares):
        """
        the Turtle creates square and rectangle
        """
